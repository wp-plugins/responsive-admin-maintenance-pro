...
function fcwebmaintenance_option_page()
{
    ...
    $fcwebSettings['facebookLink'] = "www.facebook.com/freelancingcare";
    $fcwebSettings['twitterLink'] = "www.twitter.com/freelancingcare";
    $fcwebSettings['googleLink'] = "www.google.com/+Freelancingcare";
